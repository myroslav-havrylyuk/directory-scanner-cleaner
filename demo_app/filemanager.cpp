...
FileTreeElement *FileManager::generateFileTree(const QString &rootPath)
{
...
quint64 FileManager::getDirectorySize(const QString &directory)
{
    quint64 size = 0;
...
QList<FileTreeElement *> FileManager::getInnerFiles(const QDir &currenDir, FileTreeElement *parent)
{
